                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" class="form-control" id="username" name="username"
                                            value="{{ $user->username }}" placeholder="User name" aria-label="John Doe"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="phone" id="phone" class="form-control" name="phone"
                                            value="{{ $user->phone }}" placeholder="Phone" aria-label="ACME Inc."
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="email" id="email" name="email" class="form-control"
                                            value="{{ $user->email }}" placeholder="Email" aria-label="john.doe"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="date" id="date_of_birth" class="form-control" name="date_of_birth"
                                            value="{{ $user->date_of_birth }}" placeholder="" aria-label="ACME Inc."
                                            aria-describedby="basic-icon-default-company2" />
