                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title" value="{{ old('title') }}" placeholder="title" aria-label="John Doe" aria-describedby="basic-icon-default-fullname2" />
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" id="content" class="form-control" name="content" value="{{ old('content') }}" placeholder="Price of product" aria-label="ACME Inc." aria-describedby="basic-icon-default-company2" />
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <textarea id="image_name" class="form-control" name="image_name" value="{{ old('image_name') }}" placeholder="" aria-label="" aria-describedby="basic-icon-default-message2"></textarea>
