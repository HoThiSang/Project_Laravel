...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <form action="{{  route('admin.create-new-product') }}" method="post">
            @csrf
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" id="price" class="form-control" name="price" value="{{ old('price') }}" placeholder="Price of product" aria-label="ACME Inc." aria-describedby="basic-icon-default-company2" />
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" id="discount" name="discount" class="form-control" value="{{ old('discount') }}" placeholder="Discount of product" aria-label="john.doe" aria-describedby="basic-icon-default-email2" />
                                </div>
                                @error('discount')
                                <span style="color: red;">{{$message}}</span>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" id="quantity" name="quantity" value="{{ old('quantity') }}" class="form-control phone-mask" placeholder="Quantity" aria-describedby="quantity" />
                                </div>
                                @error('quantity')
                                <span style="color: red;">{{$message}}</span>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" id="brand" class="form-control" name="brand" value="{{ old('brand') }}" placeholder="Brand of product" aria-label="ACME Inc." aria-describedby="basic-icon-default-company2" />
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <textarea id="description" name="description" value="{{ old('description') }}" class="form-control" placeholder="Description for your product" aria-label="Hi, Do you have a moment to talk Joe?" aria-describedby="basic-icon-default-message2"></textarea>
                            ...
                            <button type="submit" onclick="event.preventDefault() ; uploadImg()" class=" btn btn-primary">Create new</button>
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <textarea id="ingredient" class="form-control" name="ingredient" value="{{ old('ingredient') }}" placeholder="Ingredient for your product" aria-label="" aria-describedby="basic-icon-default-message2"></textarea>
                            ...
                            <div class="mb-3">
                                <input type="text" id="imageUrl" name="url" value="">
