...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/admin/boxicons.css" />

    <link rel="stylesheet" href="/assets/css/admin/core.css" class="template-customizer-core-css" />
    <link rel="stylesheet" href="/assets/css/admin/theme-default.css" class="template-customizer-theme-css" />
...
<body>
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="{{ route('admin-user') }}" class="menu-link">
                                    ...
                                    <div data-i18n="Account">User page</div>
                                </a>
                            </li>
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="{{ route('admin-categories') }}" class="menu-link">
                                    <div data-i18n="Error">Categories page</div>
                                </a>
                            </li>
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                                    <div class="avatar avatar-online">
                                        <img src="https://down-vn.img.susercontent.com/file/cdf9af013aa652eb0596cb252b1101d4_tn" alt class="w-px-40 h-auto rounded-circle" />
                                    </div>
                                </a>
                ...
                <footer class="content-footer footer bg-footer-theme">
                    <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                        <div class="mb-2 mb-md-0">
                            ...
                            , made with ❤️ by
                            <a href="https://themeselection.com" target="_blank" class="footer-link fw-bolder">V_SPlush</a>
                        </div>
                        <div>
    ...
    <!-- Vendors JS -->
    <script src="/assets/js/admin/apexcharts.js"></script>
