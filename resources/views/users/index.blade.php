        ...
        <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder ">
            ...
            <div id="hero">
                <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
                    <div class="item"
                        style="background-image: url('https://lavenderstudio.com.vn/wp-content/uploads/2017/03/chup-anh-san-pham.jpg');">
                        <div class="container-fluid">
                            <div class="caption bg-color vertical-center text-left">
                                ...
                                <div class="button-holder fadeInDown-3"> <a href="{{ route('categories') }}"
                                        class="btn-lg btn btn-uppercase btn-primary shop-now-button">Shop Now</a> </div>
                            </div>
                        </div>
                    </div>
                    <div class="item"
                        style="background-image: url('https://img3.thuthuatphanmem.vn/uploads/2019/09/16/anh-banner-quang-cao-my-pham-kem-chong-nam_083546551.jpg');">
                        <div class="container-fluid">
                            <div class="caption bg-color vertical-center text-left">
                                <div class="slider-header fadeInDown-1">Spring 2016</div>
                                <div class="big-text fadeInDown-1"> Women <span class="highlight">Beauty</span> </div>
                                <div class="excerpt fadeInDown-2 hidden-xs"> <span>Nemo enim ipsam voluptatem quia voluptas
                                        sit aspernatur aut odit aut fugit</span> </div>
                    ...
                    <div class="col-md-7 col-sm-7">
                        <div class="wide-banner cnt-strip">
                            <div class="image"> <img class="img-responsive"
                                    src="https://img3.thuthuatphanmem.vn/uploads/2019/09/16/anh-banner-quang-cao-my-pham-kem-chong-nam_083546551.jpg"
                                    alt=""> </div>
                        </div>
                    </div>
                        ...
                        <div class="item item-carousel">
                            <div class="products">
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image"> <a
                                                href="{{ route('detail', ['id' => $productdiscount->id]) }}"><img
                                                    src="{{ asset('images/' . $productdiscount->image_url) }}"
                                                    alt=""></a> </div>
                                        <div class="tag hot"><span>hot</span></div>
                                    </div>
                                    <div class="product-info text-left">
                                        ...
                                        <div class="product-price"> <span class="price">
                                                {{ $productdiscount->discounted_price }}</span> <span
            ...
            <div class="wide-banners wow fadeInUp outer-bottom-xs">
                <div class="row">
                    <div class="col-md-12">
                        <div class="wide-banner cnt-strip">
                            <div class="image"> <img class="img-responsive"
                                    src="https://bloganchoi.com/wp-content/uploads/2018/01/thuong-hieu-duoc-my-pham-la-roche-posay.jpg"
                                    alt=""> </div>
                        ...
                        <div class="item item-carousel">
                            <div class="products">
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image"> <a
                                                href="{{ route('detail', ['id' => $productsSuggested->id]) }}"><img
                                                    src="{{ asset('images/' . $productsSuggested->image_url) }}"
                                                    alt=""></a> </div>
                                    ...
                                    <div class="product-info text-left">
                                        <h3 class="name"><a
                                                href="detail.html">{{ $productsSuggested->product_name }}</a></h3>
                                        <div class="rating rateit-small"></div>
                                        <div class="description"></div>
