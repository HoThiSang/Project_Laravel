						...
						<div class="col-md-4 ">
							<div class="register-form" role="form">
								<div class="form-group">
									<label class="info-title" for="username">Your Name <span>*</span></label>
									<input type="text" class="form-control unicase-form-control text-input" name="username" value="{{ old('username') }}">
									@error('username')
						...
						<div class="col-md-4">
							<div class="register-form" role="form">
								<div class="form-group">
									...
									<input type="email" class="form-control unicase-form-control text-input" name="email" value="{{ old('email') }}">
									@error('email')
									<span style="color: red;">{{$message}}</span>
									@enderror
								</div>
						...
						<div class="col-md-4">
							<div class="register-form" role="form">
								<div class="form-group">
									...
									<input type="text" class="form-control unicase-form-control text-input" name="title" value="{{ old('email') }}">
									@error('title')
									<span style="color: red;">{{$message}}</span>
									@enderror
								</div>
						...
						<div class="col-md-12">
							<div class="register-form" role="form">
								<div class="form-group">
									...
									<textarea class="form-control unicase-form-control" name="message" value="{{ old('message') }}"></textarea>
									@error('message')
									<span style="color: red;">{{$message}}</span>
									@enderror
								</div>
