                                    ...
                                    <div class="product-item-holder size-big">
                                        <div id="owl-single-product">
                                            <div class="single-product-gallery-item mt-3" id="slide1">
                                                <img src="{{ $product_images[0]->image_url }}" alt="Product Image"
                                                ...
                                                @foreach ($product_images as $image)
                                                    <div class="small-image">
                                                        <img src="{{ $image->image_url }}" alt="Product Image"
                                                            class="img-fluid" data-large-image="{{ $image->image_url }}"
                                        ...
                                        @if (isset($product))
                                            ...
                                            <div class="quantity-container info-container">
                                                <div class="row">
                                                    ...
                                                    <button class="btn btn-primary addToWishlist" type="button"
