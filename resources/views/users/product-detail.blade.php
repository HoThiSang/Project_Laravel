                                ...
                                <div class="product-item-holder size-big">
                                    <div id="owl-single-product">
                                        <div class="single-product-gallery-item mt-3" id="slide1">
                                            <img src="{{ '/images/' . $product_images[0]->image_url }}" alt="Product Image"
                                                class="img-fluid" height="400" width="450" id="large-image">
                                        </div>
                                        <div class="small-images mt-3">
                                            @foreach ($product_images as $image)
                                                <div class="small-image">
                                                    <img src="{{ '/images/' . $image->image_url }}" alt="Product Image"
                                                        class="img-fluid"
                                                        data-large-image="{{ '/images/ ' . $image->image_url }}"
                                                        height="100" width="128"
                                                        onclick="changeLargeImage('{{ $image->image_url }}')">
                                                </div>
                                            @endforeach
                                        </div>
                                    </div>
                                                        ...
                                                        <div class="quant-input">
                                                            <div class="arrows">
                                                                <div class="arrow plus gradient"><span class="ir"><i
                                                                            class="icon fa fa-sort-asc increment-btn"></i></span>
                                                                </div>
